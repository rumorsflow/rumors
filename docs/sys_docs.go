...
// SwaggerInfosys holds exported Swagger Info so clients can modify it
var SwaggerInfosys = &swag.Spec{
	Version:          "1.0",
	Host:             "",
	BasePath:         "/sys/api",
	Schemes:          []string{},
	...
	Description:      "",
	InfoInstanceName: "sys",
	SwaggerTemplate:  docTemplatesys,
}

func init() {
	swag.Register(SwaggerInfosys.InstanceName(), SwaggerInfosys)
}
